...
<html>
    ...
    <body>        
        <div id="header">
            <div id="h_left">
                ...
                <button class="btn-word"><i class="fas fa-comments fa-2x"></i></button>
            ...
            <div class="discuss">
                <div>
                    <ul class="discuss-header">
                        ...
                        <li><h2 style="margin-top:7px; vertical-align: middle;">討論板</h2></span></li>
                    </ul>                       
                </div>
                <!--討論板-->
    ...
    <script>     
        ...
        <script>viewBoard(<?PHP echo $_SESSION['fid']?>, '<?PHP echo $forum;?>');</script>
</html>
